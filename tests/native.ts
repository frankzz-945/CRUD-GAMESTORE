...
import type { TiendaVideojuegos } from "../target/types/tienda_videojuegos";
...
describe("Test", () => {
  ...
  const program = anchor.workspace.TiendaVideojuegos as anchor.Program<TiendaVideojuegos>;
